  ...
  return (
    <div>
      ...
      <div className="add-movie-form">
        ...
        <button className='crud1' onClick={() => navigate("/crudhome")}>List1</button>
        <button className='crud2' onClick={() => navigate("/crudhome2")}>List2</button>
        <button className='crud3' onClick={() => navigate("/crudhome3")}>List3</button>
      </div>
